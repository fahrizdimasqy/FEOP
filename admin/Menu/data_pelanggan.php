 ...
 <div class="table-responsive">
       <table class="table table-hover data-table table-striped tablesorter">
		...
		<tr>
			...
			<td>
			<a class="btn btn-sm btn-danger" onclick="return confirm('anda yakin ingin menghapusnya?')" href="?menu=hapus_pelanggan&id_pelanggan=<?php echo $data['IDPelanggan']; ?>" title="Hapus"> <span class="glyphicon glyphicon-trash" aria-hidden="true"> </span> Hapus </a>
			<a class="btn btn-sm btn-warning" title="Edit" href="?menu=edit_pelanggan&id_pelanggan=<?php echo $data['IDPelanggan']; ?>"> <span class="glyphicon glyphicon-pencil" aria-hidden="true"> </span> Edit </a>
