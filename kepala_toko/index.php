    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Kepala Toko- FOEP (<?php echo $profil['nama']; ?>)</a>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li <?php if ($menu=="data_pelanggan"||$menu=="edit_pelanggan"||$menu=="hapus_pelanggan") {echo "class='active' "; } ?>><a href="?menu=data_pelanggan"> <span class="glyphicon glyphicon-user">
           </span> Pelanggan</a></li></a></li>

            <li <?php if ($menu=="data_tarif") {echo "class='active' "; } ?>><a href="?menu=data_tarif">
