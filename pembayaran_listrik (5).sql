...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2019 at 04:33 AM
...
CREATE TABLE `level` (
  ...
  `nama_level` varchar(11) NOT NULL
...
(8, 12, 'Fahriz', 'Kp cempaka', 'T001'),
(9, 12, 'Asep Sukandar2', 'dsada', 'K003');
...
(1, 'Fahriz Dimasqy', 'Kp cempaka Putih jawa barat', '081588792112', 'aktif', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin'),
...
--
ALTER TABLE `pelanggan`
  MODIFY `IDPelanggan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tarif`
  MODIFY `IDTarif` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
